...
const TurtleDBArchitecture = () => {
  return (
    <div>
      ...
      <img className="w-100" src="../images/architecture/1-stores.png" />
      ...
      <img className="w-100" src="../images/architecture/2-store.png" />
      ...
      <img className="w-100" src="../images/architecture/3-updating.png" />
      ...
      <img className="w-100" src="../images/architecture/4-deleting.png" />
      ...
      <img className="w-100" src="../images/architecture/5-metastore.png" />
      ...
      <img className="w-100" src="../images/architecture/6-synctostore.png" />
      ...
      <img className="w-100" src="../images/architecture/7-syncfromstore.png" />
      ...
      <img className="w-100" src="../images/architecture/8-turtlemeta.png" />
